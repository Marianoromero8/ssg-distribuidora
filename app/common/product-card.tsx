...
export default function ProductCard({ image, productName, presentation }: CardProps) {
    return (
        <div className="flex flex-col p-5 text-[##4166e0] border-1 w-64 min-h-[350px] h-full transition-transform duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">
