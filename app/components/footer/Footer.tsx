            ...
            <div className="container mx-auto flex flex-row items-start gap-4 pl-8">
                ...
                <div className="flex flex-col gap-6 align-middle">
                    ...
                    <div className="flex flex-col gap-2 justify-start">
                        ...
                        <p className="flex flex-row items-center gap-2"><FaClock />Horarios de Atención: Lunes a Viernes - 08:00 a 15:00 hs</p>
                        <p className="flex ml-44 items-end gap-2">Sábados - 08:00 a 13:00 hs</p>
                    </div>
