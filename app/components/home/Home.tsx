...
//     return (
//         <div className="flex flex-col sm:flex-row text-[#4166e0] gap-12 p-6 mb-6 w-full pt-44 sm:pt-14">
//             <div className="flex flex-col justify-center items-center w-full ml-20 p-8">
//                 <motion.h1
//                     className="text-4xl sm:text-5xl text-center leading-none"
...
export default function Home() {
    ...
    return (
        <div className="flex flex-col-reverse sm:flex-row text-[#4166e0] gap-12 p-6 mb-6 w-full min-h-screen pt-48 sm:pt-14">
            {/* Texto y Botones */}
